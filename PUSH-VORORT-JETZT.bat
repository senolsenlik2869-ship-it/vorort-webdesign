...
git add index.html public/mobile-fix.css src/components/ui/particle-text-effect.tsx src/AgencyApp.tsx src/agency.css
git commit -m "Fix mobile showcase layout" >nul 2>&1
